// Camera/Camera.c  [backend: Direct3D 11]
...
// ============================================================
// FORWARD DECLARATION — compartilhada com Sprites (DX11)
// ============================================================

// Sprites.c (DX11) deve expor esta função para receber a MVP
// Declaramos aqui para evitar dependência circular de headers.
...
// ============================================================
// VIEW MATRIX (4×4 column-major)
//
// Equivale a: translate(-cx, -cy) → rotate(-rot) → scale(zoom)
//
// Idêntica ao backend GL — a matemática não muda.
// ============================================================
...
// ============================================================
// PONTO DE INTEGRAÇÃO — chamado por RendererDX11.c a cada frame
// ============================================================
...
void tupi_camera_frame(int largura, int altura) {
    ...
    // DX11: envia a MVP para o constant buffer b0 (sem shader handle)
    tupi_dx11_atualizar_projecao(&mvp);

    // Sprites também precisam da mesma MVP
    tupi_sprite_set_projecao(mvp.m);
}

// ============================================================
// CONVERSÕES DE COORDENADAS  (idênticas ao backend GL)
// ============================================================
...
void tupi_camera_tela_para_mundo(const TupiCamera* cam,
    ...
    float cy = -(sy - altura   * 0.5f); // Y invertido
...
// ============================================================
// API PÚBLICA  (idêntica ao backend GL)
// ============================================================
...
// ============================================================
// WRAPPERS PARA FFI LUA  (idênticos ao backend GL)
// ============================================================
